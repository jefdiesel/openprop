...
import { ArrowRight, ArrowLeft, CheckCircle, Target, TrendingUp, Users } from "lucide-react";
import { Button } from "@/components/ui/button";
import { Card, CardContent, CardHeader, CardTitle } from "@/components/ui/card";
import { Badge } from "@/components/ui/badge";

export const metadata: Metadata = {
  title: "Marketing Proposal Template: Win Agency Clients [Free Template] - SendProp",
  description:
              ...
              <CardContent className="py-12 text-center">
                ...
                <div className="mb-8">
                  <p className="text-primary-foreground/90 mb-4">
                    <strong>SendProp</strong> helps marketing agencies:
                  </p>
